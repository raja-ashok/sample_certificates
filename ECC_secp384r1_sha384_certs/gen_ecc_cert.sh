...
openssl ecparam -genkey -name secp384r1 -conv_form uncompressed -outform PEM -out ec.pem
openssl req -newkey ec:ec.pem -passout pass:123456 -sha384 \
...
openssl x509 -req -in rootreq.pem -passin pass:123456 -sha384 \
...
openssl x509 -req -in serv_proxy_req.pem -passin pass:123456 -sha384 \
